...
export default function SettingsPage() {
  ...
  return (
    <div className="flex h-screen flex-col overflow-y-auto">
      <header className="flex h-16 shrink-0 items-center border-b border-border px-8">
        <div>
      ...
      <div className="mx-auto flex w-full max-w-2xl flex-col gap-5 px-8 py-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Guardrails on how much any single paper can spend. Always overridable
              per upload.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-5">
            <div className="grid gap-1.5">
              ...
              <input
                ...
                onChange={(e) =>
                  settings.setBudgetCap(Number(e.target.value))
                }
            ...
            <div className="flex items-center justify-between rounded-md border border-border bg-muted/30 p-3">
              <div>
                ...
                <p className="mt-0.5 text-[11px] text-muted-foreground">
                  ...
                  the biggest cost saver). Enable this if your appendix contains
                  inline lemmas.
                </p>
              </div>
              <ToggleSwitch
            ...
            <div className="rounded-md border border-border bg-muted/30 p-3 text-[11px] text-muted-foreground">
              ...
              Self-hosters set <code className="rounded bg-muted px-1 font-mono">SERVICE_MARKUP=1.0</code> in{" "}
              <code className="rounded bg-muted px-1 font-mono">.env</code> for raw pass-through.{" "}
              <Link
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Which LLM Loupe uses for the extract and verify steps. Vision
              localization always uses a vision-capable model, set in the backend.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            ...
            <p className="text-[11px] text-muted-foreground">
              ...
              <code className="rounded bg-muted px-1 font-mono">.env</code>. A future
              release will surface key status here.
            </p>
          </CardContent>
        </Card>
